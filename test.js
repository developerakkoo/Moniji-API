...
// console.log(
//     moment(moment().toDate(), "MM-DD-YYYY").toDate()
// );
// moment().subtract(1, 'moths').startOf('isoMonth').format('DD-MM-YY')
// moment().subtract(1, 'months').endOf('isoMonth').format('DD-MM-YY')
console.log(moment().subtract(3, 'months').startOf('isoMonth').format('MM'));
console.log(moment().subtract(1, 'months').endOf('isoMonth').format('MM'));
